...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        /**
		 * OPCION 1
		 * aqui se encuentran todos lo que necesitaremos para el ejercicio 
		 */
		 ...
		 * OPCION 2
		 * @param int serie
		 * aqui solamente pondremos la variable int la cual seria el tope de la serie
		 */
        ...
        /**
		 * OPCION 3
		 * las variables que necesitamos para el ejercicio 3
		 */
        int operacion = 0, numero, res = 0;

        /**
		 * OPCION 4
		 * estos son la mayoria de las variables que ocuparemos, 
		 * Se creara tambien un array de ser necesario
		 */
		 ...
		 * OPCION 8
		 * Opcion 9
		 * Se mandaran a llamar las clases y estara documentado en cada clase
		 */
        ...
        do {
            ...
            System.out.println("Opcion 9: Relacion Composicion.");
            System.out.println("--------------------------------------------");
            ...
            switch (respuesta) {
                case 1:
                	/**
    				 * Se le por teclado la cantidad de materias para poder comenzar el ciclo
    				 */
                    ...
                    for (int i = 0; i < materia; i++) {
                        ...
                        for (int n = 0; n < number_alumno; n++) {
                            ...
                            /**
    						 * Para saber la cantidad de los alumnos que presentaron la materia
    						 * 
    						 */
                            if (calif_mat != -1) {
                                alumnos_materia++;
                            ...
                            /**
    						 * Los numero de alumnos que no aprobaron
    						 */
                            if (calif_mat < 8 && calif_mat > 0) {
                                na++;
                            }
                            /**
    						 * Los numero de alumnos aprovados
    						 */
                            if (calif_mat > 7.9) {
                                aprovados++;
                            }
                            /**
    						 * Los numero de alumnos con DESTACADO
    						 * Destacado= > 8.9 && < 10 
    						 */
                            ...
                            /**
    						* Los numero de alumnos con AUTONOMO
    						* Autonomo = 10
    						*/
                            if (calif_mat == 10) {
                                au++;
                        ...
                        /**
    					 * Se regresa todo a 0 para hacer el proceso de la siguiente materia
    					 */
                        alumnos_materia = 0;
                        suma = 0;
                        au = 03;
                ...
                case 2:
                    ...
                    for (int i = 1; i <= serie; i++) {
                        ...
                        /**
    					 * Se le añadira la condicion para que no se haga un ciclo infinito
    					 */
                ...
                case 8:
                    ...
                    do {
                        System.out.println("-------------------------------------------------------");
                        System.out.println("Bienvenido a nuestro Service Senter.");
                        System.out.println("-------------------------------------------------------");
                        ...
                        switch (resp) {
                            ...
                            case 3:
        						 ...
        						 */
                                for (int i = 0; i < serv.getVehiculos().length; i++) {
                                    System.out.println(serv.getVehiculos()[i].toString());
                                    System.out.println();
                                }
                                break;
                    ...
                    break;
                case 9:
                	System.out.println("El ejercicio 7 se realizo con composicion.");
                	System.out.println("por lo tanto sera el mismo procedimiento");
                	Main main=new Main();
                	main.menu();
                	break;
                default:
